...
═══════════════════════════════════════════════════════════════════════
  AHMED  ·  GitHub: to7vx
  AI Engineer | Workflow Automation & Agentic Systems | Cloud | DevOps | QA
═══════════════════════════════════════════════════════════════════════
-->
...
### 🛡️ &nbsp; SecureWatch
**AI phishing-email triage agent**
> Open-source FastAPI + CLI tool that scores suspicious emails using Claude/GPT, runs static IOC checks, and ships with a ready-to-import **n8n** workflow. BYOK + Ollama support.

`Python` · `FastAPI` · `Claude API` · `n8n` · `Docker`
